...
def main(spark):
    ...
    df = spark.read.parquet("hdfs:/user/bm106_nyu_edu/1004-project-2023/interactions_test_small.parquet")
    ...
    merged_df.repartition(5000, 'recording_idx').write.mode("overwrite").parquet("indexed_test_small.parquet")
